...
CREATE TABLE public."Card" (
	...
	"Colors" int4[] NOT NULL,
	"Supertypes" int4[] NOT NULL,
	"Types" int4[] NOT NULL,
	"Subtypes" int4[] NOT NULL,
	"CreatedAt" timestamptz NOT NULL,
	"UpdatedAt" timestamptz NOT NULL,
...
CREATE TABLE public."Rulling" (
	"Id" int4 GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE) NOT NULL,
	"CardId" int4 NOT NULL,
	"Key" uuid NOT NULL,
	"Text" varchar NOT NULL,
	"Date" timestamptz NOT NULL,
	CONSTRAINT "PK_Rulling" PRIMARY KEY ("Id"),
	CONSTRAINT "UN_RullingKey" UNIQUE ("Key"),
	CONSTRAINT "FK_Rulling_Card_Id" FOREIGN KEY ("CardId") REFERENCES public."Card"("Id")
);
